...
export default function LandingPage({ params: { lng } }: {
    ...
    return (
        ...
        >
          ...
          <Dialog.Panel className='fixed inset-y-0 right-0 z-50 w-full px-6 py-6 overflow-y-auto bg-white sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 dark:bg-boxdark dark:text-white'>
            <div className='flex items-center justify-between'>
              ...
              >
                ...
                <AiFillCloseCircle className='w-6 h-6' aria-hidden='true' />
              </button>
            </div>
                ...
                <div className='py-6 space-y-2'>
                  {navigation.map((item) => (
                    <a
                      ...
                      href={item.href}
                      onClick={() => setMobileMenuOpen(false)}
                      className='block px-3 py-2 -mx-3 text-base font-semibold leading-7 text-gray-900 rounded-lg hover:bg-gray-50 dark:text-white dark:hover:bg-boxdark-2'
                    >
                      {item.name}
                    </a>
                  ))}
            ...
            <main className='isolate dark:bg-boxdark-2'>
                ...
                <div className='relative w-full pt-14 '>
                    <div
                        className='absolute top-0 right-0 w-full overflow-hidden -z-10 transform-gpu blur-3xl sm:top-0 '
                        aria-hidden='true'
                    >
                        <div
                    ...
                    <div className='py-24 sm:py-32'>
                        <div className='px-6 mx-auto max-w-8xl lg:px-8'>
                            <div className='max-w-3xl mx-auto text-center lg:mb-18'>
                                <h1 className='text-4xl font-bold text-gray-900 sm:text-6xl dark:text-white'>
                                    Automate <span className='italic'>your</span> browser
                                    By ChatGPT
                                </h1>
                                <p className='max-w-2xl mx-auto mt-6 text-lg leading-8 text-gray-600 dark:text-white'>
                                ...
                                <div className='flex items-center justify-center mt-10 gap-x-6'>
                                    ...
                                    <Link
                                        ...
                                        className='rounded-md flex items-center px-3.5 py-2.5 text-sm font-semibold text-gray-700 ring-1 ring-inset ring-gray-200 hover:ring-2 hover:ring-yellow-300 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:text-white'
                                    >
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="1.2rem" width="1.2rem" xmlns="http://www.w3.org/2000/svg"><path d="M511.6 76.3C264.3 76.2 64 276.4 64 523.5 64 718.9 189.3 885 363.8 946c23.5 5.9 19.9-10.8 19.9-22.2v-77.5c-135.7 15.9-141.2-73.9-150.3-88.9C215 726 171.5 718 184.5 703c30.9-15.9 62.4 4 98.9 57.9 26.4 39.1 77.9 32.5 104 26 5.7-23.5 17.9-44.5 34.7-60.8-140.6-25.2-199.2-111-199.2-213 0-49.5 16.3-95 48.3-131.7-20.4-60.5 1.9-112.3 4.9-120 58.1-5.2 118.5 41.6 123.2 45.3 33-8.9 70.7-13.6 112.9-13.6 42.4 0 80.2 4.9 113.5 13.9 11.3-8.6 67.3-48.8 121.3-43.9 2.9 7.7 24.7 58.3 5.5 118 32.4 36.8 48.9 82.7 48.9 132.3 0 102.2-59 188.1-200 212.9a127.5 127.5 0 0 1 38.1 91v112.5c.8 9 0 17.9 15 17.9 177.1-59.7 304.6-227 304.6-424.1 0-247.2-200.4-447.3-447.5-447.3z"></path></svg>

                                        <span className='ml-2'>View The Repo </span>
                                    </Link>
                                </div>
                            </div>


                            <div className='flow-root mt-14 sm:mt-14 '>
                ...
                {/* Clients section */}
                <div className='flex flex-col px-6 mx-auto mt-12 max-w-7xl lg:px-8 items-between gap-y-6'>
                    <h2 className='mb-6 font-semibold tracking-wide text-center text-gray-500 dark:text-white'>
                        Built with / Used by:
                    </h2>

                    <div className='grid items-center max-w-lg grid-cols-2 mx-auto gap-x-8 gap-y-12 sm:max-w-xl md:grid-cols-4 sm:gap-x-10 sm:gap-y-14 lg:mx-0 lg:max-w-none'>
                        <div className='flex justify-center object-contain w-full col-span-1 max-h-12 dark:opacity-80'>
                ...
                {/* Feature section */}
                <div id='features' className='px-6 mx-auto mt-48 max-w-7xl lg:px-8'>
                            ...
                            {features.map((feature) => (
                                <div key={feature.name} className={`relative pl-16`}>
                                    <dt className='text-base font-semibold leading-7 text-gray-900 dark:text-white'>
                                        <div className='absolute top-0 left-0 flex items-center justify-center w-10 h-10 border border-yellow-400 rounded-lg bg-yellow-100/50 dark:bg-boxdark'>
                ...
                <div className='mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8'>
                    <div className='relative -m-2 sm:left-5 rounded-xl bg-yellow-400/20 lg:ring-1 lg:ring-yellow-500/50 lg:-m-4 '>
                        <div className='relative px-8 py-20 bg-gray-900 shadow-xl sm:top-5 sm:right-5 dark:bg-boxdark sm:rounded-xl sm:px-10 sm:py-16 md:px-12 lg:px-20'>
                            <h2 className='text-xl font-semibold leading-7 tracking-wide text-left text-gray-500 dark:text-white'>
                                What Our Users Say
                            </h2>
                            <div className='relative z-10 flex flex-wrap justify-between w-full gap-6 mt-6 lg:mx-0'>
                                {testimonials.map((testimonial) => (
                                    <figure className='box-content flex flex-col justify-between w-full p-8 lg:w-1/4 rounded-xl bg-gray-500/5 '>
                ...
                {/* FAQ */}
                <div className='max-w-2xl px-6 pb-8 mx-auto mt-32 divide-y divide-gray-900/10 dark:divide-gray-200/10 sm:pb-24 sm:pt-12 lg:max-w-7xl lg:px-8 lg:py-32'>
            ...
            {/* Footer */}
            <div className='px-6 mx-auto mt-6 max-w-7xl lg:px-8 dark:bg-boxdark-2'>
                <footer
                    aria-labelledby='footer-heading'
                    className='relative py-24 border-t border-gray-900/10 dark:border-gray-200/10 sm:mt-32'
                >
                    <h2 id='footer-heading' className='sr-only'>
                        Footer
                    </h2>
                    <div className='flex items-start justify-end gap-20 mt-10'>
                        <div>
