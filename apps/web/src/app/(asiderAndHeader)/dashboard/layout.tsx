  ...
  return (
    <Layout style={{ minHeight: '100vh', maxHeight: '100vh' }}>
      ...
      <Layout>
          ...
          <div className="menu-page">
            <ConfigProvider theme={{
              ...
              <Menu onMouseEnter={handleMouseEnter}
                ...
                onMouseLeave={handleMouseLeave} className={collapsed ? 'collapsed' : ''} inlineCollapsed={collapsed} mode="vertical" theme="light"  >

                {/* icon={<IconData className="svg-icons" />} */}
                <Menu.Item key={'/project/models'} >
                  <Link href={'/project/models'}>Models</Link>
                </Menu.Item>
                {/*  icon={<Assistant className="svg-icons" />} */}
                <Menu.Item key={`/project/assistants`}>
                  <Link href={'/project/assistants'}>Assistants</Link>
                </Menu.Item>
                {/* icon={<Retrieval className="svg-icons" />} */}
                <Menu.Item key={'/project/collections'} >
                  <Link href={'/project/collections'}>Retrieval</Link>
                </Menu.Item>
                {/* icon={<Plugin className="svg-icons" />}  */}
                <Menu.Item key={'/project/tools'} onClick={handleSubMenu}>
                  <Link href={'/project/tools'}>Tools</Link>
                </Menu.Item>

                {/*  icon={<Playground className="svg-icons" />} */}
                <Menu.Item key={'/project/playground'}>
                  <Link href={'/project/playground'}>Playground</Link>

                </Menu.Item>
                {/* icon={<Apikeys className="svg-icons" />} */}
                <Menu.Item key={'/project/apikeys'} >
                  <Link href={'/project/apikeys'}>API Keys</Link>
                </Menu.Item>
                {/* icon={<Back className="svg-icons" />}  */}
                <Menu.Item onClick={handleBack} className='orgination' key='/'>
        ...
        {isOpen && <Sider width={210} theme="light">
          <div className="menu-page">
            <ConfigProvider theme={{
              ...
              <Menu mode="vertical" theme="light" onClick={handleSubMenuClick}>
        ...
        {/* closeIcon={<CloseIcon />} */}
        <Modal title='Logout' centered open={logoutOpen}
